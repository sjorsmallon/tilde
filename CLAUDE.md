...
- **The bake rides the map PACKAGE** beside the navmesh, so a downloaded map is lit like the listen server's. Sidecar and package are version 8; an older one is REFUSED, never migrated. (`lightmap_def.md` §3)
