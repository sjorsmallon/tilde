...
// Schema serializes shared::box_face_t through the Int32 path (matching layout).
template <>
struct Schema_Type_Info<shared::box_face_t>
{
...
class Displacement_Entity : public Entity_Of<::entity_type::DISPLACEMENT>
{
public:
  ...
  SCHEMA_FIELD_DEFAULT(shared::box_face_t, active_face,
  ...
  void init_displacement(shared::box_face_t face, int subdiv);
