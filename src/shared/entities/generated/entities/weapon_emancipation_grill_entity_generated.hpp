...
//
// Weapon_Emancipation_Grill_Entity: what it IS, and what it can be TOLD.
//
...
struct Weapon_Emancipation_Grill_Entity : Entity
{
  static constexpr entity_type static_type = entity_type::Weapon_Emancipation_Grill_Entity;

  Weapon_Emancipation_Grill_Entity() { type = entity_type::Weapon_Emancipation_Grill_Entity; }

  Enabled switch_state = {};
  Box_Volume volume = {.half_extents = {64.0f, 128.0f, 8.0f}};
  Render render = {.mesh = assets::mesh_asset::Box, .material = {.shader_type = Shader_Type::Ghost, .color = {1.0f, 0.25f, 0.2f}}};
};
...
static_assert(std::is_trivially_copyable_v<Weapon_Emancipation_Grill_Entity>,
              "Weapon_Emancipation_Grill_Entity must stay trivially copyable: pooled storage, snapshot "
              "baselines and undo all copy entities with memcpy");
static_assert(std::is_trivially_destructible_v<Weapon_Emancipation_Grill_Entity>,
              "Weapon_Emancipation_Grill_Entity must stay trivially destructible: the entity pool frees a "
              "slot by overwriting it and runs no destructor");
static_assert(std::is_base_of_v<Entity, Weapon_Emancipation_Grill_Entity>,
              "Weapon_Emancipation_Grill_Entity must derive from Entity: the generated tables hand out "
              "Entity* for every entity type");

// --- what a Weapon_Emancipation_Grill_Entity accepts ---
//
...
// --- what a Weapon_Emancipation_Grill_Entity announces ---
//
