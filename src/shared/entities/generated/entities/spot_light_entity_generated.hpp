...
//
// Spot_Light_Entity: what it IS, and what it can be TOLD.
//
...
// --- what a Spot_Light_Entity accepts ---
//
...
void set_color(Spot_Light_Entity&, const Set_Color_Data&, input_context_t&);   // Colorable, this type's own: src/server/entities/spot_light_entity.cpp
...
// --- what a Spot_Light_Entity announces ---
//
