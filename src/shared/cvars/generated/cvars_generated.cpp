...
const cvar_info_t CVAR_INFO_TABLE[CVAR_COUNT] = {
    ...
    {.name = "sv_max_move_backlog",
     ...
     .string_capacity = 0},
    {.name = "cl_max_unacked_moves",
     .description = "Unacknowledged move commands resent in every move datagram",
     .flags = CVAR_FLAG_CLIENT,
     .type = CVAR_TYPE_I32,
     .offset = offsetof(cvar_state_t, cl_max_unacked_moves),
     .size = sizeof(cvar_state_t::cl_max_unacked_moves),
     .string_capacity = 0},
    {.name = "r_fov",
