...
enum class cvar_id : uint16_t
{
  ...
  cl_player_unlit = 73,
  cl_aim_debug = 74,
  cl_aim_debug_pitch = 75,
  cl_aim_debug_yaw = 76,
  cl_show_deploy_timer = 77,
  cl_crosshair = 78,
  cl_crosshair_dot = 79,
  cl_crosshair_size = 80,
  cl_crosshair_gap = 81,
  cl_crosshair_thickness = 82,
  cl_crosshair_r = 83,
  cl_crosshair_g = 84,
  cl_crosshair_b = 85,
  cl_crosshair_a = 86,
  editor_speed = 87,
  cl_timescale = 88,
  sound_reference_distance = 89,
  sound_max_distance_cutoff = 90,
  sound_rolloff_factor = 91,
  map_respawn_delay_seconds = 92,
  map_kill_limit = 93,
  map_round_time_limit_seconds = 94,
  next_map = 95,
  pin_main_thread = 96,
  r_debug_channel = 97,
  r_exposure = 98,
  sv_skybox = 99,
  debug_show_collisions = 100,
  debug_show_hitboxes = 101,
  debug_show_navmesh = 102,
  debug_show_box_volumes = 103,
  debug_hide_geometry = 104,
  cl_shot_debug_seconds = 105,
  debug_show_entity_counts = 106,
  debug_show_physics_bodies = 107,
  net_snapshot_debug = 108,
  sv_event_debug = 109,
  cl_event_debug = 110,
  sv_reliable_debug = 111,
  sv_io_debug = 112,
  replay_keyframe_seconds = 113,
  sv_replay_auto = 114,
  sv_ghost_record = 115,
};
...
constexpr uint32_t CVAR_COUNT = 116;
