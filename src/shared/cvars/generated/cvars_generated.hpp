...
enum class cvar_id : uint16_t
{
  ...
  sv_tickrate = 32,
  sv_timeout = 33,
  sv_max_move_backlog = 34,
  sv_map_transfer_fragments_per_tick = 35,
  name = 36,
  cl_max_unacked_inputs = 37,
  r_fov = 38,
  r_zoom_fov = 39,
  r_zoom_easing_time_between_fovs = 40,
  r_shadow_map_size = 41,
  r_shadow_layer_count = 42,
  r_shadow_light_offset = 43,
  r_shadow_bias_slope = 44,
  r_shadow_normal_offset = 45,
  r_shadow_pcf_radius = 46,
  r_shadow_pcss = 47,
  r_shadow_pcss_max_radius = 48,
  r_shadow_debug_light = 49,
  r_lightmap_gpu = 50,
  r_shadow_cascade_count = 51,
  r_shadow_cascade_lambda = 52,
  r_shadow_cascade_distance = 53,
  r_shadow_cascade_blend = 54,
  r_shadow_cascade_caster_extent = 55,
  r_shadow_freeze = 56,
  m_sensitivity = 57,
  m_zoom_sensitivity_ratio = 58,
  cl_maxfps = 59,
  cl_interpolation_delay_ticks = 60,
  cl_interpolation_debug = 61,
  cl_display_latency_ms = 62,
  cl_draw_player_hull = 63,
  cl_spectate_slot = 64,
  cl_noclip = 65,
  cl_player_unlit = 66,
  cl_aim_debug = 67,
