...
enum class cvar_id : uint16_t
{
  ...
  mp_players_to_start = 23,
  mp_frag_limit = 24,
  sv_aim_max_pitch = 25,
  sv_aim_max_yaw = 26,
  sv_aim_body_turn_rate = 27,
  sv_lag_compensation = 28,
  sv_max_rewind_ticks = 29,
  sv_lag_compensation_debug = 30,
  sv_shot_debug = 31,
  sv_ping_range = 32,
  sv_ping_lifetime_seconds = 33,
  sv_tickrate = 34,
  sv_timeout = 35,
  sv_max_move_backlog = 36,
  sv_map_transfer_fragments_per_tick = 37,
  name = 38,
  cl_max_unacked_inputs = 39,
  r_fov = 40,
  r_zoom_fov = 41,
  r_zoom_easing_time_between_fovs = 42,
  r_shadow_map_size = 43,
  r_shadow_layer_count = 44,
  r_shadow_light_offset = 45,
  r_shadow_bias_slope = 46,
  r_shadow_normal_offset = 47,
  r_shadow_pcf_radius = 48,
  r_shadow_pcss = 49,
  r_shadow_pcss_max_radius = 50,
  r_shadow_debug_light = 51,
  r_lightmap_gpu = 52,
  r_shadow_cascade_count = 53,
  r_shadow_cascade_lambda = 54,
  r_shadow_cascade_distance = 55,
  r_shadow_cascade_blend = 56,
  r_shadow_cascade_caster_extent = 57,
  r_shadow_freeze = 58,
  m_sensitivity = 59,
  m_zoom_sensitivity_ratio = 60,
  cl_maxfps = 61,
  cl_interpolation_delay_ticks = 62,
  cl_interpolation_debug = 63,
  cl_display_latency_ms = 64,
  cl_draw_player_hull = 65,
  cl_spectate_slot = 66,
  cl_replay_player_view = 67,
  cl_noclip = 68,
  cl_player_unlit = 69,
  cl_aim_debug = 70,
  cl_aim_debug_pitch = 71,
  cl_aim_debug_yaw = 72,
  cl_show_deploy_timer = 73,
  cl_crosshair = 74,
  cl_crosshair_dot = 75,
  cl_crosshair_size = 76,
  cl_crosshair_gap = 77,
  cl_crosshair_thickness = 78,
  cl_crosshair_r = 79,
  cl_crosshair_g = 80,
  cl_crosshair_b = 81,
  cl_crosshair_a = 82,
  editor_speed = 83,
  cl_timescale = 84,
  sound_reference_distance = 85,
  sound_max_distance_cutoff = 86,
  sound_rolloff_factor = 87,
  map_respawn_delay_seconds = 88,
  map_kill_limit = 89,
  map_round_time_limit_seconds = 90,
  next_map = 91,
  pin_main_thread = 92,
  r_debug_channel = 93,
  r_exposure = 94,
  sv_skybox = 95,
  debug_show_collisions = 96,
  debug_show_hitboxes = 97,
  debug_show_navmesh = 98,
  debug_show_box_volumes = 99,
  debug_hide_geometry = 100,
  cl_shot_debug_seconds = 101,
  debug_show_entity_counts = 102,
  debug_show_physics_bodies = 103,
  net_snapshot_debug = 104,
  sv_event_debug = 105,
  cl_event_debug = 106,
  sv_reliable_debug = 107,
  sv_io_debug = 108,
  replay_keyframe_seconds = 109,
  sv_replay_auto = 110,
};

// Not a member of the enum above, so `switch` over a cvar_id still
// warns on an unhandled case.
constexpr uint32_t CVAR_COUNT = 111;
