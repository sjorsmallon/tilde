...
enum class cvar_id : uint16_t
{
  ...
  cl_player_unlit = 68,
  cl_aim_debug = 69,
  cl_aim_debug_pitch = 70,
  cl_aim_debug_yaw = 71,
  cl_show_deploy_timer = 72,
  cl_crosshair = 73,
  cl_crosshair_dot = 74,
  cl_crosshair_size = 75,
  cl_crosshair_gap = 76,
  cl_crosshair_thickness = 77,
  cl_crosshair_r = 78,
  cl_crosshair_g = 79,
  cl_crosshair_b = 80,
  cl_crosshair_a = 81,
  editor_speed = 82,
  cl_timescale = 83,
  sound_reference_distance = 84,
  sound_max_distance_cutoff = 85,
  sound_rolloff_factor = 86,
  map_respawn_delay_seconds = 87,
  map_kill_limit = 88,
  map_round_time_limit_seconds = 89,
  next_map = 90,
  pin_main_thread = 91,
  r_debug_channel = 92,
  r_exposure = 93,
  sv_skybox = 94,
  debug_show_collisions = 95,
  debug_show_hitboxes = 96,
  debug_show_navmesh = 97,
  debug_show_box_volumes = 98,
  debug_hide_geometry = 99,
  cl_shot_debug_seconds = 100,
  debug_show_entity_counts = 101,
  debug_show_physics_bodies = 102,
  net_snapshot_debug = 103,
  sv_event_debug = 104,
  cl_event_debug = 105,
