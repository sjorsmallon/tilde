...
enum class cvar_id : uint16_t
{
  ...
  mp_freeze_seconds = 21,
  mp_round_seconds = 22,
  mp_round_end_seconds = 23,
  mp_game_over_seconds = 24,
  mp_players_to_start = 25,
  mp_frag_limit = 26,
  sv_aim_max_pitch = 27,
  sv_aim_max_yaw = 28,
  sv_aim_body_turn_rate = 29,
  sv_lag_compensation = 30,
  sv_max_rewind_ticks = 31,
  sv_lag_compensation_debug = 32,
  sv_shot_debug = 33,
  sv_ping_range = 34,
  sv_ping_lifetime_seconds = 35,
  sv_tickrate = 36,
  sv_timeout = 37,
  sv_max_move_backlog = 38,
  sv_map_transfer_fragments_per_tick = 39,
  name = 40,
  cl_max_unacked_inputs = 41,
  r_fov = 42,
  r_zoom_fov = 43,
  r_zoom_easing_time_between_fovs = 44,
  r_shadow_map_size = 45,
  r_shadow_layer_count = 46,
  r_shadow_light_offset = 47,
  r_shadow_bias_slope = 48,
  r_shadow_normal_offset = 49,
  r_shadow_pcf_radius = 50,
  r_shadow_pcss = 51,
  r_shadow_pcss_max_radius = 52,
  r_shadow_debug_light = 53,
  r_lightmap_gpu = 54,
  r_shadow_cascade_count = 55,
  r_shadow_cascade_lambda = 56,
  r_shadow_cascade_distance = 57,
  r_shadow_cascade_blend = 58,
  r_shadow_cascade_caster_extent = 59,
  r_shadow_freeze = 60,
  m_sensitivity = 61,
  m_zoom_sensitivity_ratio = 62,
  cl_maxfps = 63,
  cl_interpolation_delay_ticks = 64,
  cl_interpolation_debug = 65,
  cl_display_latency_ms = 66,
  cl_draw_player_hull = 67,
  cl_spectate_slot = 68,
  cl_replay_player_view = 69,
  cl_replay_panel = 70,
  cl_ghost_show = 71,
  cl_noclip = 72,
  cl_player_unlit = 73,
  cl_blob_shadow = 74,
  cl_blob_shadow_radius = 75,
  cl_blob_shadow_opacity = 76,
  cl_blob_shadow_max_distance = 77,
  cl_aim_debug = 78,
  cl_aim_debug_pitch = 79,
  cl_aim_debug_yaw = 80,
  cl_show_deploy_timer = 81,
  cl_crosshair = 82,
  cl_crosshair_dot = 83,
  cl_crosshair_size = 84,
  cl_crosshair_gap = 85,
  cl_crosshair_thickness = 86,
  cl_crosshair_r = 87,
  cl_crosshair_g = 88,
  cl_crosshair_b = 89,
  cl_crosshair_a = 90,
  editor_speed = 91,
  cl_timescale = 92,
  sound_reference_distance = 93,
  sound_max_distance_cutoff = 94,
  sound_rolloff_factor = 95,
  map_respawn_delay_seconds = 96,
  map_kill_limit = 97,
  map_round_time_limit_seconds = 98,
  next_map = 99,
  pin_main_thread = 100,
  r_debug_channel = 101,
  r_exposure = 102,
  sv_skybox = 103,
  debug_show_collisions = 104,
  debug_show_hitboxes = 105,
  debug_show_navmesh = 106,
  debug_show_box_volumes = 107,
  debug_hide_geometry = 108,
  cl_shot_debug_seconds = 109,
  debug_show_entity_counts = 110,
  debug_show_physics_bodies = 111,
  net_snapshot_debug = 112,
  sv_event_debug = 113,
  cl_event_debug = 114,
  sv_reliable_debug = 115,
  sv_io_debug = 116,
  replay_keyframe_seconds = 117,
  sv_replay_auto = 118,
  sv_ghost_record = 119,
};
...
constexpr uint32_t CVAR_COUNT = 120;
