...
enum class cvar_id : uint16_t
{
  ...
  cl_max_unacked_inputs = 22,
  r_fov = 23,
  r_zoom_fov = 24,
  r_zoom_easing_time_between_fovs = 25,
  m_sensitivity = 26,
  m_zoom_sensitivity_ratio = 27,
  cl_maxfps = 28,
  cl_interpolation_delay_ticks = 29,
  cl_interpolation_debug = 30,
  cl_display_latency_ms = 31,
  cl_draw_player_hull = 32,
  cl_spectate_slot = 33,
  cl_player_unlit = 34,
  cl_aim_debug = 35,
  cl_aim_debug_pitch = 36,
  cl_aim_debug_yaw = 37,
  cl_crosshair = 38,
  cl_crosshair_dot = 39,
  cl_crosshair_size = 40,
  cl_crosshair_gap = 41,
  cl_crosshair_thickness = 42,
  cl_crosshair_r = 43,
  cl_crosshair_g = 44,
  cl_crosshair_b = 45,
  cl_crosshair_a = 46,
  editor_speed = 47,
  cl_timescale = 48,
  sound_reference_distance = 49,
  sound_max_distance_cutoff = 50,
  sound_rolloff_factor = 51,
  debug_show_collisions = 52,
  debug_show_hitboxes = 53,
  debug_show_navmesh = 54,
  debug_show_box_volumes = 55,
  debug_hide_geometry = 56,
  cl_shot_debug_seconds = 57,
  debug_show_entity_counts = 58,
  debug_show_physics_bodies = 59,
  net_snapshot_debug = 60,
  sv_event_debug = 61,
  cl_event_debug = 62,
};
...
constexpr uint32_t CVAR_COUNT = 63;
