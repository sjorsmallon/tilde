...
constexpr uint32_t Debug_Channel_COUNT = 9;
...
enum class cvar_id : uint16_t
{
  ...
  r_shadow_debug_light = 44,
  r_shadow_cascade_count = 45,
  r_shadow_cascade_lambda = 46,
  r_shadow_cascade_distance = 47,
  r_shadow_cascade_blend = 48,
  r_shadow_cascade_caster_extent = 49,
  r_shadow_freeze = 50,
  m_sensitivity = 51,
  m_zoom_sensitivity_ratio = 52,
  cl_maxfps = 53,
  cl_interpolation_delay_ticks = 54,
  cl_interpolation_debug = 55,
  cl_display_latency_ms = 56,
  cl_draw_player_hull = 57,
  cl_spectate_slot = 58,
  cl_player_unlit = 59,
  cl_aim_debug = 60,
  cl_aim_debug_pitch = 61,
  cl_aim_debug_yaw = 62,
  cl_show_deploy_timer = 63,
  cl_crosshair = 64,
  cl_crosshair_dot = 65,
  cl_crosshair_size = 66,
  cl_crosshair_gap = 67,
  cl_crosshair_thickness = 68,
  cl_crosshair_r = 69,
  cl_crosshair_g = 70,
  cl_crosshair_b = 71,
  cl_crosshair_a = 72,
  editor_speed = 73,
  cl_timescale = 74,
  sound_reference_distance = 75,
  sound_max_distance_cutoff = 76,
  sound_rolloff_factor = 77,
  map_respawn_delay_seconds = 78,
  map_kill_limit = 79,
  map_round_time_limit_seconds = 80,
  pin_main_thread = 81,
  r_debug_channel = 82,
  r_exposure = 83,
  debug_show_collisions = 84,
  debug_show_hitboxes = 85,
  debug_show_navmesh = 86,
  debug_show_box_volumes = 87,
  debug_hide_geometry = 88,
  cl_shot_debug_seconds = 89,
  debug_show_entity_counts = 90,
  debug_show_physics_bodies = 91,
  net_snapshot_debug = 92,
  sv_event_debug = 93,
  cl_event_debug = 94,
  sv_reliable_debug = 95,
};

// Not a member of the enum above, so `switch` over a cvar_id still
// warns on an unhandled case.
constexpr uint32_t CVAR_COUNT = 96;
