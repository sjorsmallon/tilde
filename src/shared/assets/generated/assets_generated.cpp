...
constexpr asset_info_t mesh_asset_MANIFEST[] = {
  ...
  {"sequence_3", "resources/glb/sequence_3.glb"},
  {"sequence_4", "resources/glb/sequence_4.glb"},
  {"sequence_5", "resources/glb/sequence_5.glb"},
...
constexpr asset_info_t texture_asset_MANIFEST[] = {
  ...
  {"icon_timer", "resources/icons/icon_timer.png"},
  ...
  {"replay_pause", "resources/icons/replay_pause.png"},
  {"replay_play", "resources/icons/replay_play.png"},
  {"replay_restart", "resources/icons/replay_restart.png"},
  {"replay_speed_down", "resources/icons/replay_speed_down.png"},
  {"replay_speed_up", "resources/icons/replay_speed_up.png"},
...
constexpr asset_info_t sound_asset_MANIFEST[] = {
  ...
  {"level_complete_beat", "resources/sounds/level_complete_beat.wav"},
  {"player_jump", "resources/sounds/player_jump.wav"},
  {"player_land", "resources/sounds/player_land.wav"},
  {"player_land_new", "resources/sounds/player_land_new.wav"},
  ...
  {"timer_egg_timer", "resources/sounds/timer_egg_timer.wav"},
  {"timer_over_ding", "resources/sounds/timer_over_ding.wav"},
...
constexpr asset_info_t pbr_material_MANIFEST[] = {
  ...
  {"glass_green", "resources/textures/glass_green"},
  {"glass_pink", "resources/textures/glass_pink"},
