                 ...
                 float             dt)
{
  ...
  for (auto &bot : bots)
  {
    ...
    {
      apply_bot_movement(context, physics, session, movement_volumes, disabled_geometry, movers, *bot_ent,
    ...
    // ---- apply movement ----
    apply_bot_movement(context, physics, session, movement_volumes, disabled_geometry, movers, *bot_ent, front, input,
