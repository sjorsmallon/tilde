...
// Every entity but the players and the match goes, carried weapons included; the map's own come back as the
// map has them, and a player is back at construction but for who they are and their score.
